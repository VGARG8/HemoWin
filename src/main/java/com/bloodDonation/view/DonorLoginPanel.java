    ...
    loginButton.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        if(usernameField.getText().length()==0){
          flag = false;
          JOptionPane.showMessageDialog(new JOptionPane(),"Username can not be empty", "Error",
...
// make the HTTP request and deserialize the response body to DonorResponse object
            ...
            if (response.getStatusCode() == HttpStatus.OK && !donorResponse.getStatus()
                .equals("FAILURE")) {
//            // Switch to the appropriate panel
              ...
              JOptionPane.showMessageDialog(new JOptionPane(),
                  donorResponse.getMessage() + " or sign-up", "Error",
                  JOptionPane.ERROR_MESSAGE);
            }
