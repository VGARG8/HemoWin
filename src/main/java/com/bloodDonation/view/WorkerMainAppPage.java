      ...
      public void actionPerformed(ActionEvent e) {
        ...
        submit.addActionListener(new ActionListener() {
          ...
          public void actionPerformed(ActionEvent e) {
            ...
            cardPanel.add(new WorkerMainAppPage(cardPanel,cardLayout,workerResponse.getWorker()),"worker-main-page");
...
// make the HTTP request and deserialize the response body to ContestResponse object
    ...
    for (Appointment appointment : appointmentResponse.getUpcomingAppointments()) {
      ...
      acceptButton.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          cardPanel.add(new DonationPanel(cardPanel,cardLayout,appointment,worker),"donation-form");
