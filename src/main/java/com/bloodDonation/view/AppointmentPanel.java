...
public class AppointmentPanel extends JPanel {
  ...
  public AppointmentPanel(JPanel cardPanel, CardLayout cardLayout, Donor donor, List<Contest> contests) {
    ...
    ResponseEntity<WorkerListResponse> response = restTemplate.exchange(
...
//    addComponent(dateLabel, 0, 2);
    ...
    addButton.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        CreateAppointment createAppointment = new CreateAppointment(); // replace with your object
        ...
        if (sqlDate.compareTo(new java.sql.Date(today.getTime())) > 0) {
          ...
          flag = false;
          JOptionPane.showMessageDialog(new JOptionPane(), "Date should be of future", "Error",
        ...
        if (flag) {
          ...
          String url = "http://localhost:8080/donor/appointment"; // replace with your endpoint URL
          ResponseEntity<AppointmentResponse> responseEntity = restTemplate.postForEntity(url,
              request, AppointmentResponse.class);
