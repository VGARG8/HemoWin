...
// create request body
        ...
        if (getUsername() != null && !getUsername().equals("")) {
          ...
          flag = false;
          JOptionPane.showMessageDialog(new JOptionPane(), "User name can not be empty", "Error",
        ...
        if (getFirstName() != null && !getFirstName().equals("")) {
          ...
          flag = false;
          JOptionPane.showMessageDialog(new JOptionPane(), "First name can not be empty", "Error",
              JOptionPane.ERROR_MESSAGE);
        }

        user.setLast_name(getLastName());
        if (passwordField.getPassword().length != 0 && passwordField != null
            && passwordField.getPassword() != null && !passwordField.getPassword().toString()
            .equals("")) {
          ...
          flag = false;
          JOptionPane.showMessageDialog(new JOptionPane(), "Password can not be empty", "Error",
              JOptionPane.ERROR_MESSAGE);
        }
        ...
        if (datePicker.getModel().getValue() != null) {
          ...
          flag = false;
          JOptionPane.showMessageDialog(new JOptionPane(), "D.O.B can not be empty", "Error",
              JOptionPane.ERROR_MESSAGE);
        }
...
//          try{
            ResponseEntity<DonorResponse> response = restTemplate.postForEntity(
                "http://localhost:8080/donor/registration", requestEntity, DonorResponse.class);
            ...
            if (response.getStatusCode() == HttpStatus.OK && !response.getBody().getStatus()
                .equals("FAILURE")) {
              ...
              JOptionPane.showMessageDialog(new JOptionPane(), response.getBody().getMessage(),
                  "Error",
                  JOptionPane.ERROR_MESSAGE);
            }
