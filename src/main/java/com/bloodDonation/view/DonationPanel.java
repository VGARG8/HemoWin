...
public class DonationPanel extends JPanel {
  ...
  public DonationPanel(JPanel cardPanel, CardLayout cardLayout, Appointment appointment, Worker worker) {
        ...
        try {
          ...
          if (Integer.parseInt(amountField.getText()) > 5
            ...
            JOptionPane.showMessageDialog(new JOptionPane(),
                "Donation amount can range from 1 to 5", "Error",
          ...
          flag = false;
          JOptionPane.showMessageDialog(new JOptionPane(), "Only positive values allowed", "Error",
              JOptionPane.ERROR_MESSAGE);
        }
...
// set properties of the donation object as needed
        if (flag) {
          ...
          cardPanel.add(new WorkerMainAppPage(cardPanel, cardLayout, worker), "worker-main-app");
