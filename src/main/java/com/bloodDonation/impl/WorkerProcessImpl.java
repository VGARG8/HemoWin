...
public class WorkerProcessImpl {
  ...
  public void createWorker(Worker worker) {
    try {
      ...
      if (con != null) {
        ...
        String sql = "INSERT INTO worker (username, first_name, last_name, password, gender, date_of_joining, camp_id) VALUES (?, ?, ?, ?, ?, ?, ?)";
  ...
  public AppointmentResponse getAppointment(String workerUsername) {
    ...
    if(con!=null) {
      String sql = "SELECT * FROM appointment WHERE appointment_with =? and appointment_time >= Now() and checked_in = false order by appointment_time";
      PreparedStatement stmt = null;
