...
public class DonorService {
  @Autowired
  DonorProcessImpl donorProcessImpl;
  ...
  public ResponseEntity<ContestResponse> JoinContests(@RequestBody JoinContestRequest joinContestRequest){
  ...
  public ResponseEntity<AppointmentResponse> createAppointment(@RequestBody CreateAppointment createAppointment){
  ...
  public ResponseEntity<AppointmentResponse> DeleteAppointment(@RequestBody DeleteAppointmentRequest deleteAppointmentRequest){
    AppointmentResponse appointmentResponse = donorProcessImpl.deleteAppointment(deleteAppointmentRequest);
    return new ResponseEntity<>(appointmentResponse, HttpStatus.OK);
  }
  ...
  public ResponseEntity<DonationResponse> getDonations(@PathVariable(value = "donor_username") @NonNull String donorUsername){
